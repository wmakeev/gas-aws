...
namespace AWS.Crypto {
  ...
  export function SHA256<T extends boolean = false>(
    message: string | LibWordArray,
    options?: {
      asBytes: T
    }
  ): T extends true ? WordArray : string {
    return CryptoJs_.SHA256(...arguments)
  }

  export function HmacSHA256<T extends boolean = false>(
    message: string | LibWordArray,
    ...
    return CryptoJs_.HMAC(CryptoJs_.SHA256, ...arguments)
  }

  const CryptoJs_ = (function () {
    let window = {}
